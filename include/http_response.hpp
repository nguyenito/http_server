...
{
private:
    HttpStatusCode m_status{HttpStatusCode::NotFound};

protected:
    void buildStartLine() override;

public:
    static std::unordered_map<HttpStatusCode, std::string> REASON_PHRASE;
    static std::string GetReasonPhrase(const HttpStatusCode &statusCode);
